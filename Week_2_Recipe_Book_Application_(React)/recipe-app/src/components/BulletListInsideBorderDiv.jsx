...
export function BulletListInsideBorderDiv({name, recipe, recipeName, className = '', ...props}) {
    ...
    return (
        <div
            className={cn("relative w-[35.3rem] md:w-[61.0rem] flex flex-col border rounded-[1rem] !pb-[4.0rem]", className)} {...props}>
            <h3 className="w-full text-left !pl-[2.0rem] md:!pl-[4.0rem] !pt-[1.6rem] !pb-[1.5rem] md:!pb-[2.5rem] text-[4.0rem] md:text-[6.4rem] text-[var(--black)] font-normal font-justme">{name}</h3>
